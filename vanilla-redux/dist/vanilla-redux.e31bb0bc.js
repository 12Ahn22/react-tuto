...
var btnDecrease = document.querySelector('#decrease'); // 1. 액션 이름 선언하기

var TOGGLE_SWITCH = 'TOGGLE_SWITCH';
var INCREASE = 'INCREASE';
var DECREASE = 'DECREASE'; // 액션 이름으로 액션 객체를 만드는 액션 함수 선언하기
...
var store = (0, _redux.createStore)(reducer); // 5. 렌더 함수 만들기
// 상태가 업데이트 될 때마다 호출된다.

var render = function render() {
  // store에 있는 내장 메서드로 현재 상태를 불러온다.
  var state = store.getState(); // 토글 처리하기
...
var unsubscribe = store.subscribe(listener); // 구독 비활성화 함수
...
},{"redux":"node_modules/redux/es/redux.js"}],"C:/Users/ahn/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/ahn/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
